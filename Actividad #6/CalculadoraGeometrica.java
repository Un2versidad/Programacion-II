...
public class CalculadoraGeometrica {
    ...
    private static String calcularCirculo(Scanner sc, int operacion) {
        ...
        return operacion == 1 ? String.format("Área del círculo: %.2f", Math.PI * Math.pow(radio, 2)) : String.format("Perímetro del círculo: %.2f", 2 * Math.PI * radio);
    }
    ...
    private static String calcularCuadrado(Scanner sc, int operacion) {
        ...
        return operacion == 1 ? String.format("Área del cuadrado: %.2f", lado * lado) : String.format("Perímetro del cuadrado: %.2f", 4 * lado);
    }
    ...
    private static String calcularRectangulo(Scanner sc, int operacion) {
        ...
        return operacion == 1 ? String.format("Área del rectángulo: %.2f", largo * ancho) : String.format("Perímetro del rectángulo: %.2f", 2 * (largo + ancho));
    }
    ...
    private static String calcularPentagono(Scanner sc, int operacion) {
        ...
        return operacion == 1 ? String.format("Área del pentágono: %.2f", (5 * lado * getValidInput(sc, "Ingrese la apotema del pentágono: ", Double::parseDouble, input -> input > 0)) / 2) : String.format("Perímetro del pentágono: %.2f", 5 * lado);
    }
